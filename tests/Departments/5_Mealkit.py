...
class TesROTIKIT(ui_test_class.UVXVXIVClass):
    ...
    def test_clickmeal5(self):
        time.sleep(3)
        self.mealkit_page.click_Biweekly()
        self.mealkit_page.click_5mealkit()
    ...
    def test_clickmeal5_M(self):
        ...
        # self.mealkit_page.click_DetailsMisalpav2()
        # self.mealkit_page.click_CloseDetailsMisalpav2()
