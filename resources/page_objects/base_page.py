...
class BasePage:
    ...
    def get_browser_instance(cls):
        ...
        driver = selenium.webdriver.Chrome(options=chrome_options, desired_capabilities=caps, executable_path="C:\\Users\\user\\PycharmProjects\\pythonProject\\chromedriver.exe")
